...
Original file is located at
    https://colab.research.google.com/drive/115YpAwyPDeJgRAzBB5FBZ8-wZ1F7ZCV9
"""
...
#               % (epoch + 1, train_l_sum / batch_count, train_acc_sum / n, test_acc, time.time() - start))
        ...
        if test_acc > best_test_acc:
            print('find best! save at ./model/EMAbest.pth')
            best_test_acc = test_acc
            PATH = '/content/drive/My Drive/python/EMAbest.pth'
            torch.save(net.state_dict(), PATH)
            torch.save(ema,'/content/drive/My Drive/python/EMA.pth')
...
batch_size = 64 
train_iter, test_iter  = load_data_fashion_mnist(batch_size, use_normalize=True, mean=dataset_global_mean, std=dataset_global_std)
...
net = net.to(device)
ema = torch.load('/content/drive/My Drive/python/EMA.pth')
ema.model= net
test_acc = evaluate_accuracy(test_iter, net, ema)
print(test_acc)